...
## 🚀 Features
* **Simple UI/UX:** Clean, distraction-free interface for quick uploads.
* **Custom Watermarking:** Add any text (e.g., "Purchased by: email@domain.com") directly onto the document.
